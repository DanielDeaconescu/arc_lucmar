    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="menuLinks">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item">
                    <a href="services.php"
                        class="nav-link <?= $current_page == 'services.php' ? 'active' : '' ?>">Servicii</a>
                </li>
                <li class="nav-item">
                    <a href="portfolio.php"
                        class="nav-link <?= $current_page == 'portfolio.php' ? 'active' : '' ?>">Portofoliu</a>
                </li>
                <li class="nav-item">
                    <a href="contact.php"
                        class="nav-link btn btn-outline-secondary px-4 mx-4 <?= $current_page == 'contact.php' ? 'active' : '' ?>">Contact</a>
                </li>
            </ul>
        </div>
    </div>
